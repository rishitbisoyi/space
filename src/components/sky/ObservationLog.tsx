  ...
  return (
    <div className="mc-panel">
      <div className="mc-panel-header">
        <span className="status-led green blink-led" />
        <span className="mc-panel-title">OBSERVATION LOG</span>
      ...
      <div className="mc-panel-body">
        <div className="obs-log">
          {entries.map((entry, i) => (
            <div
              key={i}
              className={`obs-line obs-line--${entry.status}`}
            >
              ...
              {i === entries.length - 1 && (
                <span className="obs-cursor blink-led">_</span>
              )}
            </div>
          ))}
        </div>
